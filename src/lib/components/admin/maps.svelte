              ...
              <div class="relative flex-1 px-1 h-full overflow-hidden">
                ...
                {#if tilesetConfig}
                  <div class="w-full h-full flex gap-2">
                    <div class="w-1/4 h-full relative">
                      ...
                      >
                        <li class="me-2">
                          <a
                            href="#"
                            on:click={() => (selectedTab = 'tiles')}
                            aria-current="page"
                            class="inline-block p-4 rounded-t-lg {selectedTab === 'tiles'
                              ? 'active text-blue-600 bg-gray-100'
                              : 'hover:text-gray-600 hover:bg-gray-50'}">Tiles</a
                          >
                        </li>
                        <li class="me-2">
                          <a
                            href="#"
                            on:click={() => (selectedTab = 'objects')}
                            class="inline-block p-4 rounded-t-lg {selectedTab === 'objects'
                              ? 'active text-blue-600 bg-gray-100'
                              : 'hover:text-gray-600 hover:bg-gray-50'}">Objects</a
                          >
                        </li>
                      </ul>
                      {#if selectedTab === 'tiles'}
                        <div class="relative h-full w-full overflow-y-scroll">
                          ...
                          <div
                            class="absolute top-0 left-0 w-full h-full flex flex-wrap box-border"
                          >
                    ...
                    {#if edited}
                      <div
                        class="w-3/4 h-full flex flex-col gap-3 relative"
                        bind:this={editorContainer}
                      >
                        <div
                          class="w-full flex flex-wrap justify-between gap-4 min-h-12"
                        ...
                        >
                          <div class="flex flex-wrap content-start gap-4">
                            <div id="selectedTile" class="border-1 border-black w-10 h-10">
                              <canvas class="w-full h-full" bind:this={selectedTilePreview}
                              ></canvas>
                            </div>
                            <button
                              type="button"
                        ...
                        <div
                          class="w-full flex justify-end min-h-16 pb-3"
